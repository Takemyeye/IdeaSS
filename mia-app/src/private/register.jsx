      ...
      <div className="main">
         <div className="container-register">
            ...
            <h3>{translation.signInText}</h3>
              <div className="auth">
                <a href='https://discord.com/oauth2/authorize?client_id=1258613251705671690&response_type=code&redirect_uri=https%3A%2F%2Fbelance.netlify.app%2F&scope=identify+guilds+email'> 
                  <div className="login">
